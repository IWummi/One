...
public class World {
	...
	/**
	 * Should the connectivity simulation be stopped after one round -setting id
	 * ({@value}). Boolean (true/false) variable.
	 */
	...
	public void update() {
		...
		while (this.nextQueueEventTime <= runUntil) {
			...
			// added
			System.out.println(this.nextEventQueue.nextEvent());
			// added
